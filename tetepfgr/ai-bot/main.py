...
ВАЖНО: Используй ТОЛЬКО реальные названия из документации! Например:
- ПРАВИЛЬНО: "В разделе «Справочники» выберите пункт «Горизонты»"
- НЕПРАВИЛЬНО: "Откройте меню слева и выберите раздел «Уровень 0»"
