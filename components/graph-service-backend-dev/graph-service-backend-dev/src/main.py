...
from app.routers.events_stream import events_stream_router
...
from app.routers.map_settings import map_setting_router
...
from app.routers.vehicles import vehicle_router
...
app.include_router(shaft_router, prefix="/api")
app.include_router(map_setting_router, prefix="/api")
app.include_router(location_router, prefix="/api")
app.include_router(route_router, prefix="/api")
app.include_router(events_stream_router, prefix="/api")
app.include_router(vehicle_router, prefix="/api")
app.include_router(ladder_nodes_router, prefix="/api")
