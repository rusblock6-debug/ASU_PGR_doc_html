"""Чтение скорости ТС из Redis (стримы telemetry-service:speed:{vehicle_id})."""
...
REDIS_KEY_PREFIX = "telemetry-service:speed:"
...
def get_vehicle_speed(vehicle_id: str | int) -> float | None:
    """Прочитать скорость по vehicle_id из Redis Stream telemetry-service:speed:{vehicle_id}.
    Возвращает последнее значение speed/value или None, если данных нет.
    """
