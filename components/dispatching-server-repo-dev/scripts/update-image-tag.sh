...
#   ./update-image-tag.sh enterprise-service registry.dmi-msk.ru/enterprise-service 0.1.456 .env_server_dev
#
...
# Исключения для compose-алиасов задаются ниже.
# =============================================================================
...
if [ $# -lt 3 ]; then
    ...
    echo "  $0 enterprise-service registry.dmi-msk.ru/enterprise-service 0.1.456 .env_server_dev"
    exit 1
fi
...
# вроде trip-service-server -> DISPA_BACKEND_* тоже обновлялись корректно.
