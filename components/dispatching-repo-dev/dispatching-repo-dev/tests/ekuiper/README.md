...
```bash
task test-ekuiper               # ~30 сек
task test-ekuiper-with-mocks    # ~30 сек, с моками
```
...
```bash
task test-ekuiper-full                  # ~2.5 мин
task test-ekuiper-with-mocks-full       # ~2.5 мин, с моками
```
...
```bash
task test-ekuiper-with-mocks            # БЕЗ E2E
task test-ekuiper-with-mocks-full       # С E2E
```
