...
from src.app.model import VehicleTelemetry
...
_ALLOWED_FIELDS = frozenset(VehicleTelemetry.__struct_fields__)
...
class VehicleTelemetryRepository(ClickHouseRepository[VehicleTelemetry]):
