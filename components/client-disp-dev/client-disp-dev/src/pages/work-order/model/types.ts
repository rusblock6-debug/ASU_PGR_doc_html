...
export interface WorkOrderState {
  ...
  /** ID выбранных машин для фильтрации (пустой массив = показывать все). */
  ...
  /** ID серверных заданий для удаления сгруппированные по vehicleId. */
...
export interface RouteTaskDraft {
  /** ID задачи (серверный или локальный). */
  readonly id: string;
  /** ID места погрузки. */
