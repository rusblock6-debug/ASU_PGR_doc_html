...
import { HorizonFilter, Mode, TreeNode } from '../types';
...
export const modeConfig = {
  key: 'asu-gtk-map-mode',
  selector: (state) => state.mode,
  defaultValue: Mode.VIEW,
} as const satisfies PersistFieldConfig<ModeValue>;

export const horizonFilterConfig = {
  key: 'asu-gtk-map-horizon-filter',
  selector: (state) => state.horizonFilter,
  defaultValue: HorizonFilter.ALL,
} as const satisfies PersistFieldConfig<HorizonFilterValue>;
