...
import { selectIsVisibleHistoryPlayer, selectMapMode } from '../../../../model/selectors';
import { Mode, type ObjectListSortField } from '../../../../model/types';
...
interface ObjectListProps {
  ...
  /** Идентификатор скрытых объектов для отображения состояния видимости в каждой строке. */
...
export function ObjectList({
  ...
  const gridTemplateColumns = [
    isHistoryMode && !isVisibleHistoryPlayer && 'auto',
    'auto',
    '1fr',
    hasStock && 'auto',
    hasHorizon && 'auto',
  ...
  return (
    ...
    >
      <div
        ...
        role="row"
      >
        {isHistoryMode && !isVisibleHistoryPlayer && <span />}
