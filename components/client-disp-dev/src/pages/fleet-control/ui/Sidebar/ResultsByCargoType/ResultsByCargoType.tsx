...
import { formatNumber, roundToFixed } from '@/shared/lib/format-number';
          ...
          {dataSource.length > 0 ? (
            dataSource.map((row, index) => (
              ...
              >
                ...
                <div className={styles.table_cell}>{formatNumber(roundToFixed(row.volume_sections_m3))} м³</div>
                <div className={styles.table_cell}>{formatNumber(roundToFixed(row.volume_places_m3))} м³</div>
              </div>
            ))
          ) : (
