 ...
 * @param placesOptions.load список опций пунктов погрузки.
 * @param placesOptions.unload список опций пунктов разгрузки.
 */
