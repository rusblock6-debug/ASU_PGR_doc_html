...
export interface NavLinks {
  ...
  readonly items?: readonly {
    ...
    readonly url: string;
    /** Ключ страницы из AppRoutes для идентификации в избранном (FavoriteButton) и закреплённых страницах (PinPageButton). Используется для getRoutePermission в useFilteredNavLinks. */
