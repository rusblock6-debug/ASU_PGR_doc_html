...
export interface HorizonGraphResponse {
  ...
  readonly nodes: readonly NodeGraph[];
  /** Возвращает список рёбер графа (горизонтальных и вертикальных). */
  readonly edges: readonly EdgeGraph[];
  ...
  /** Возвращает список переездов (лестниц) на графе. */
...
export interface NodeGraph {
  ...
  readonly node_type: 'road' | 'ladder';
  /** Возвращает JSON-строку связанных узлов вида `{"horizon_id": node_id}`. */
  readonly linked_nodes: string | null;
...
export interface EdgeGraph {
  ...
  readonly edge_type: 'horizontal' | 'vertical';
  ...
  /** Возвращает дату изменения. */
  readonly updated_at: string;
  /** Возвращает идентификатор горизонта. `null` для вертикальных рёбер между горизонтами. */
  readonly horizon_id: number | null;
}

/** Представляет модель переезда (лестницы) между горизонтами. */
export interface Ladder {
  /** Возвращает идентификатор. */
  readonly id: number;
  /** Возвращает идентификатор горизонта-источника. */
  readonly from_horizon_id: number;
  /** Возвращает идентификатор целевого горизонта. */
  readonly to_horizon_id: number;
