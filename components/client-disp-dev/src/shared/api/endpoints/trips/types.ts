...
export interface Trip {
  /** Идентификатор цикла/рейса (первичный ключ, одинаковый для Cycle и Trip). */
  ...
  /** Объем рейса (м³). */
  readonly change_volume: number | null;
  /** Вес рейса (тонны), рассчитанный по типу руды. */
  readonly change_weight: number | null;
