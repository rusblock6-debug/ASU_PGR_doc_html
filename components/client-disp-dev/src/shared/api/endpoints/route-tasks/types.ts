...
export interface RouteTaskUpsertItem {
  /** Идентификатор маршрутного задания (undefined/null = create). */
  readonly id?: string | null;
  /** Идентификатор смены. Опционально, заполняется автоматически при вложенности. */
  readonly shift_task_id?: string | null;
...
export interface ActivateRouteTaskRequest {
  /** Идентификатор маршрутного задания для активации. */
...
export interface CancelRouteTaskRequest {
  /** Идентификатор маршрутного задания для отмены. */
  readonly taskId: string;
  /** Идентификатор транспортного средства. */
  readonly vehicleId: string;
}
