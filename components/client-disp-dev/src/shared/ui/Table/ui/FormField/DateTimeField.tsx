...
export function DateTimeField({ column, mode }: Readonly<FormFieldProps>) {
        ...
        <DateTimePicker
          ...
          minDate={
            hasValue(columnWithMinValue) && formWatch[columnWithMinValue]
              ? tz.toTimezone(new Date(formWatch[columnWithMinValue] as string))
              : undefined
          }
          maxDate={
            hasValue(columnWithMaxValue) && formWatch[columnWithMaxValue]
              ? tz.toTimezone(new Date(formWatch[columnWithMaxValue] as string))
              : undefined
          }
        />
      )}
