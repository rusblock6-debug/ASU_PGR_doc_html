...
/** Значение контекста для управления боковыми панелями kiosk-лейаута. */
...
/** Props для {@link KioskAsideProvider}. */
...
/** Провайдер контекста боковых панелей kiosk-лейаута. */
...
/** Хук доступа к контексту боковых панелей. Требует {@link KioskAsideProvider} выше по дереву. */
